...
{
  grafo = new GrafoLista(false, true);
}
...
TEST_F(GrafoListaTest, InserirVertice)
{
...
TEST_F(GrafoListaTest, RemoverVertice)
{
...
TEST_F(GrafoListaTest, InserirAresta)
{
  grafo->inserirVertice("A");
  grafo->inserirVertice("B");
...
TEST_F(GrafoListaTest, RemoverAresta)
{
  grafo->inserirVertice("A");
  grafo->inserirVertice("B");
...
TEST_F(GrafoListaTest, ExisteAresta)
{
  grafo->inserirVertice("A");
  grafo->inserirVertice("B");
  grafo->inserirAresta(0, 1, 10);
...
TEST_F(GrafoListaTest, PesoAresta)
{
  grafo->inserirVertice("A");
  grafo->inserirVertice("B");
  grafo->inserirAresta(0, 1, 10);
...
TEST_F(GrafoListaTest, VizinhosVertice)
{
  grafo->inserirVertice("A");
  grafo->inserirVertice("B");
  grafo->inserirVertice("C");
...
TEST_F(GrafoListaTest, LabelVertice)
{
  grafo->inserirVertice("A");
  EXPECT_EQ(grafo->labelVertice(0), "A");
